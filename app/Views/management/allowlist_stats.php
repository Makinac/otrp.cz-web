...
<section class="section">
    <div class="container">
        ...
        <h2 class="section-heading">Allowlist statistiky</h2>

        <!-- Period tabs -->
        <div class="stats-period-tabs">
            <?php foreach ($periodOptions as $val => $label): ?>
                <a href="/management/allowlist-stats?period=<?= htmlspecialchars((string)$val) ?>"
        ...
        <p style="margin-top:1rem;font-size:0.75rem;color:var(--grey-dim);">
            ...
            Ø čas kontroly = průměrná doba od podání formuláře po jeho schválení/zamítnutí.
        </p>
    </div>
</section>
